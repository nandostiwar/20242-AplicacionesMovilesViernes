...
//   const [changeUsername, setChangeUsername] = useState(""); // Agregado aquí
...
//           ); // Alert para credenciales incorrectas
//         }
//       })
//       .catch(() => {
//         alert("Error al conectar con el servidor."); // Alert en caso de error de conexión
//       });
//   };
...
//       method: "POST",
//       headers: { "Content-Type": "application/json" },
//       body: JSON.stringify({ username: changeUsername, newPassword }),
//     })
//       .then((res) => res.json())
//       .then((response) => {
...
//         } else {
//           alert("Error: " + response.message); // Alert en caso de error, como usuario no existente
//         }
//       })
//       .catch(() => {
//         alert("Error al conectar con el servidor."); // Alert en caso de error de conexión
