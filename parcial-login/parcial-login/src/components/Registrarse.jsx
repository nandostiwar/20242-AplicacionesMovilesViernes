...
function Registrarse({ callback }) {
    ...
    const validateUser = (event) => {
        ...
        fetch(`http://localhost:4000/login`, {
            ...
            body: JSON.stringify({ user: username, pass: password, rol: rol }) // Asegúrate de usar los nombres correctos de los campos según tu servidor
        })
            .then(res => res.json())
            .then(responseData => {
    ...
    return (
        <form onSubmit={validateUser}>
            ...
            <select id="rol" onClick={handleSelect}>
