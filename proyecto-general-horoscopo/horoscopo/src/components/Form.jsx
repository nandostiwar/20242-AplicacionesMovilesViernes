...
function Form({ callback }) {
    ...
    return (
        <form onSubmit={validateUser}>
            ...
            <button type="button" onClick={Update} id="btnUpdate">Actualizar información</button>
            <button onClick={Register} id="btnRegistro">Registro</button> {/* Botón de Actualizar */}
        </form>
    );
